...
const ProjectCard = ({ imgURL, title, tags, projectLink, classes }) => {
    return (
        <div className={`relative p-4 rounded-2xl bg-zinc-800 hover:bg-zinc-700/50 active:bg-zinc-700/60 ring-1 ring-inset ring-zinc-50/5 transition-all ${classes}`}>
            <figure className='img-box aspect-square rounded-lg mb-4 '>
                <img src={imgURL} alt={title} loading='lazy' className='img-cover' />
            </figure>
