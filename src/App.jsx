...
const experienceData = [
  {
    role: "Student Lab Assistant – OOP Lab (Java)",
    company: "FAST NUCES",
    duration: "February 2025 - May 2025",
    description:
      "Helped 40+ students in mastering core Java and OOP concepts through labs and guidance. Helped debug code and reinforced clean, efficient programming practices.",
    tech: ["Java", "OOP", "Communication"],
    logoURL: "/fast.png",
  },
  {
    role: "Teaching Assistant – Software Design and Architecture",
    company: "FAST NUCES",
    duration: "September 2024 – December 2024",
    description:
      "Assessed 50+ students’ assignments and projects, focusing on UML diagrams and design patterns. Reviewed final software/web projects and provided feedback on structure and implementation.",
    tech: ["UML", "Design Patterns"],
    logoURL: "/fast.png",
  }
];
...
const contactUsSocialLinks = [
  {
    href: 'https://github.com/Rayyanalii',
  ...
  {
    href: 'https://www.linkedin.com/in/ayyanalii/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/rayyanalii_',
